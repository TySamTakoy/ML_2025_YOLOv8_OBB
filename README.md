...
На примерах снизу (```exmpl1.png``` и ```exmpl2.png```) слева открыто окно «Фотографии» — стандартное приложение для просмотра фотографий в Windows 11, справа – реализованное решение для просмотра изображений и определенных моделью аннотаций в режиме реального времени:

<img width="624" height="284" alt="exmpl1" src="https://github.com/user-attachments/assets/8bc1149f-ba68-46a9-91cc-df6e7a20cc1f" />

<img width="624" height="280" alt="exmpl2" src="https://github.com/user-attachments/assets/e270338d-7f8d-485b-9380-69ba2ab81ab0" />
